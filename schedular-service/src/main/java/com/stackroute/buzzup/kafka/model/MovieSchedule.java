...
public class MovieSchedule {
	...
	public MovieSchedule(String theatreId, String theatreName, String emailId, String theatreLocation,
			...
			String[] typesOfSeats, String[] numberOfSeats, String[] screenedmovies, String[] runningmovies, String id,
			...
			int showNumbers, String showTimings, String[] weekendsPrice, String[] weekdaysPrice) {
		super();
