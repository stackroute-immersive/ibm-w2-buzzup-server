...
import com.stackroute.buzzup.recommendationservice.repository.MovieRepository;
...
public class MovieServiceImpl implements MovieService {
	...
	public void getMovieNode(MovieSchedule movie) {
		...
		/*Theatre theatreObj = new Theatre(movie.getTheatreId(), movie.getTheatreName(), movie.getTheatreLocation(),
				movie.getTheatreCity(), movie.getSeatLayout(), movie.getShowNumbers(), movie.getShowTimings(),
				movie.getWeekdaysPrice(), movie.getWeekendsPrice(), movie.getNumberOfSeats(), movie.getTypesOfSeats());
				movie.getScreenedmovies(), movie.getRunningmovies()
		*/
